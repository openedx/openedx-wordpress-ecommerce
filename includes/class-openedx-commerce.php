...
class Openedx_Commerce {
	...
	private function define_admin_hooks() {
		...
		$this->loader->add_action( 'woocommerce_order_status_processing', $plugin_admin, 'process_order_data', 10, 2 );
		$this->loader->add_action( 'woocommerce_thankyou', $plugin_admin, 'set_order_status_completed', 10, 2 );
		$this->loader->add_action( 'woocommerce_email_enabled_customer_processing_order', $plugin_admin, 'disable_processing_email_for_auto_completed_orders', 10, 2 );
