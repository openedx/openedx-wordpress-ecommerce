...
class Openedx_Woocommerce_Plugin_Enrollment_Info_Form
{
    ...
    {
        $this->_log_manager = new Openedx_Woocommerce_Plugin_Log();
    }
...
?>
    ...
    {
        $post_id = $post->ID;
        $logs = $this->_log_manager->getLogs($post_id);
    ?>
